...
const MONGO_URI = process.env.MONGO_URI || 'mongodb://localhost:27017/task_tracker';
...
async function seedDefaultUsers() {
  ...
  if (!guestExists) {
    ...
    // Pre-create guest account; password not required, but set a default hash for safety
