(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))o(a);new MutationObserver(a=>{for(const r of a)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&o(i)}).observe(document,{childList:!0,subtree:!0});function t(a){const r={};return a.integrity&&(r.integrity=a.integrity),a.referrerPolicy&&(r.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?r.credentials="include":a.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function o(a){if(a.ep)return;a.ep=!0;const r=t(a);fetch(a.href,r)}})();const I="http://localhost:5050/api",E={async request(e,s,t=null){const o=`${I}${s}`,a=localStorage.getItem("token"),r={"Content-Type":"application/json"};a&&(r.Authorization=`Bearer ${a}`);const i={method:e,headers:r};t&&(i.body=JSON.stringify(t));try{const n=await fetch(o,i),l=await n.json();if(!n.ok)throw new Error(l.error||`HTTP error! status: ${n.status}`);return l}catch(n){throw console.error(`API Error on ${e} ${s}:`,n),n}},getTasks(e={}){const s=new URLSearchParams;Object.keys(e).forEach(a=>{e[a]!==void 0&&e[a]!==null&&e[a]!==""&&s.append(a,e[a])});const t=s.toString(),o=t?`/tasks?${t}`:"/tasks";return this.request("GET",o)},getTask(e){return this.request("GET",`/tasks/${e}`)},createTask(e){return this.request("POST","/tasks",e)},updateTask(e,s){return this.request("PUT",`/tasks/${e}`,s)},deleteTask(e){return this.request("DELETE",`/tasks/${e}`)},logTime(e,s,t){return this.request("POST",`/tasks/${e}/log-time`,{minutes:s,user_id:t})},getCategories(){return this.request("GET","/categories")},createCategory(e){return this.request("POST","/categories",e)},deleteCategory(e){return this.request("DELETE",`/categories/${e}`)},getUsers(){return this.request("GET","/users")},createUser(e){return this.request("POST","/users",e)},postComment(e,s){return this.request("POST",`/tasks/${e}/comments`,s)},getStats(){return this.request("GET","/dashboard/stats")},getActivityLogs(){return this.request("GET","/activity-logs")},exportData(){return this.request("GET","/system/export")},importData(e){return this.request("POST","/system/import",e)},register(e){return this.request("POST","/auth/register",e)},login(e){return this.request("POST","/auth/login",e)},guestLogin(){return this.request("POST","/auth/guest-login")},getProfile(){return this.request("GET","/auth/profile")},logout(){return this.request("POST","/auth/logout")}};window.API=E;const B={formatMinutes(e){if(!e||isNaN(e)||e<=0)return"0m";const s=Math.floor(e/60),t=e%60;return s===0?`${t}m`:t===0?`${s}h`:`${s}h ${t}m`},formatDate(e){if(!e)return"No due date";const s=new Date(e);return isNaN(s.getTime())?e:s.toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"})},isOverdue(e){if(!e)return!1;const s=new Date;s.setHours(0,0,0,0);const t=new Date(e);return t.setHours(0,0,0,0),t<s},showToast(e,s="info"){const t=document.getElementById("notification-toast");if(!t)return;t.style.borderColor=s==="error"?"var(--priority-urgent)":"var(--primary)",t.style.boxShadow=s==="error"?"0 10px 30px rgba(0,0,0,0.5), 0 0 15px rgba(235, 87, 87, 0.3)":"0 10px 30px rgba(0,0,0,0.5), 0 0 15px var(--primary-glow)";const o=s==="error"?'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>':'<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>';t.innerHTML=`${o} <span>${e}</span>`,t.classList.remove("hidden"),this.toastTimeout&&clearTimeout(this.toastTimeout),this.toastTimeout=setTimeout(()=>{t.classList.add("hidden")},3e3)},getCategoryStyle(e){return e?`background: ${e.replace(")",", 0.12)").replace("hsl","hsla")}; border: 1px solid ${e}; color: ${e};`:"background: rgba(255,255,255,0.05); color: #fff;"},getChartOptions(){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:"#c4cbd4",font:{family:"'Inter', sans-serif",size:11}}}},scales:{x:{grid:{color:"rgba(255, 255, 255, 0.05)"},ticks:{color:"#8b98a5",font:{family:"'Inter', sans-serif"}}},y:{grid:{color:"rgba(255, 255, 255, 0.05)"},ticks:{color:"#8b98a5",font:{family:"'Inter', sans-serif"}}}}}}};window.Utils=B;const S={users:[],categories:[],charts:{},calendarDate:new Date,async initialize(){try{this.users=await API.getUsers(),this.categories=await API.getCategories()}catch(e){console.error("Failed to initialize components metadata:",e)}},async renderDashboard(e){const s=document.getElementById(e);if(s){s.innerHTML='<div class="loading">Loading dashboard metrics...</div>';try{const t=await API.getStats();s.innerHTML=`
      ...
      `,this.renderDashboardCharts(t)}catch(t){s.innerHTML=`<div class="error-msg">Error loading dashboard: ${t.message}</div>`}}},renderDashboardCharts(e){this.charts.workload&&this.charts.workload.destroy(),this.charts.time&&this.charts.time.destroy();const s=document.getElementById("chart-workload"),t=document.getElementById("chart-time");if(!s||!t)return;const o=e.category_distribution.map(d=>d.category_name||"Uncategorized"),a=e.category_distribution.map(d=>d.count),r=e.category_distribution.map(d=>d.category_color||"#8b98a5"),i=e.time_spent_by_category.map(d=>d.category_name||"Uncategorized"),n=e.time_spent_by_category.map(d=>d.total_actual_minutes||0),l=e.time_spent_by_category.map(d=>d.category_color||"#8b98a5");this.charts.workload=new Chart(s,{type:"bar",data:{labels:o,datasets:[{label:"Tasks Count",data:a,backgroundColor:r.map(d=>d.replace(")",", 0.35)").replace("hsl","hsla")),borderColor:r,borderWidth:1.5,borderRadius:6}]},options:Utils.getChartOptions()}),this.charts.time=new Chart(t,{type:"doughnut",data:{labels:i,datasets:[{data:n,backgroundColor:l.map(d=>d.replace(")",", 0.45)").replace("hsl","hsla")),borderColor:l,borderWidth:1.5}]},options:{...Utils.getChartOptions(),scales:{x:{display:!1},y:{display:!1}},cutout:"70%"}})},async renderKanban(e){const s=document.getElementById(e);if(s){s.innerHTML='<div class="loading">Loading Kanban Board...</div>';try{const t=await API.getTasks(),o={Todo:[],"In Progress":[],Review:[],Completed:[]};t.forEach(r=>{o[r.status]&&o[r.status].push(r)});let a='<div class="kanban-board">';for(const[r,i]of Object.entries(o)){const n=r.toLowerCase().replace(" ","");a+=`
          <div class="kanban-column" data-status="${r}" ondragover="Components.onDragOver(event)" ondragleave="Components.onDragLeave(event)" ondrop="Components.onDrop(event, '${r}')">
            <div class="column-header">
              ...
              <span class="column-count">${i.length}</span>
            </div>
            <div class="column-cards-container">
        `,i.forEach(l=>{const d=l.priority.toLowerCase(),c=Utils.getCategoryStyle(l.category_color),u=l.status!=="Completed"&&Utils.isOverdue(l.due_date),v=l.due_date?Utils.formatDate(l.due_date):"";a+=`
      ...
      `,document.getElementById("list-filter-search").addEventListener("input",i=>{this.currentFilters.search=i.target.value,this.fetchAndRenderListBody()}),document.getElementById("list-filter-status").addEventListener("change",i=>{this.currentFilters.status=i.target.value,this.fetchAndRenderListBody()}),document.getElementById("list-filter-priority").addEventListener("change",i=>{this.currentFilters.priority=i.target.value,this.fetchAndRenderListBody()}),document.getElementById("list-filter-category").addEventListener("change",i=>{this.currentFilters.category_id=i.target.value,this.fetchAndRenderListBody()}),document.getElementById("list-filter-assignee").addEventListener("change",i=>{this.currentFilters.assignee_id=i.target.value,this.fetchAndRenderListBody()})}this.fetchAndRenderListBody()},async fetchAndRenderListBody(){const e=document.getElementById("list-tasks-body");if(e)try{let s=await API.getTasks(this.currentFilters);if(s.sort((o,a)=>{let r=o[this.sortBy],i=a[this.sortBy];return r==null&&(r=""),i==null&&(i=""),typeof r=="string"?this.sortOrder==="asc"?r.localeCompare(i):i.localeCompare(r):this.sortOrder==="asc"?r-i:i-r}),s.length===0){e.innerHTML='<tr><td colspan="7" style="text-align: center; color: var(--text-muted);">No tasks match selected filter criteria.</td></tr>';return}let t="";s.forEach(o=>{const a=o.priority.toLowerCase(),r=o.status.toLowerCase().replace(" ",""),i=Utils.getCategoryStyle(o.category_color),n=o.status!=="Completed"&&Utils.isOverdue(o.due_date);t+=`
          <tr>
            <td>
              <span class="list-task-title" onclick="Components.showTaskDetails('${o.id}')">${o.title}</span>
            </td>
            <td>
              <span class="status-badge ${r}">${o.status}</span>
            </td>
            <td>
              <span class="priority-tag ${a}">${o.priority}</span>
            </td>
            <td>
              ${o.category_name?`<span class="category-tag" style="${i}">${o.category_icon} ${o.category_name}</span>`:'<span class="text-muted">—</span>'}
            </td>
            <td>
              ${o.assignee_name?`
      ...
      `;for(let m=r;m>0;m--){const f=n-m+1;d+=`
          <div class="calendar-cell inactive">
            <div class="calendar-date">${f}</div>
          </div>
        `}const c=new Date().toISOString().split("T")[0];for(let m=1;m<=i;m++){const f=new Date(o,a,m),w=`${o}-${(a+1).toString().padStart(2,"0")}-${m.toString().padStart(2,"0")}`,L=t.filter(g=>g.due_date===w);d+=`
          <div class="calendar-cell ${w===c?"today":""}">
            ...
            <div style="display: flex; flex-direction: column; gap: 0.3rem; overflow-y: auto; flex-grow: 1;">
              ${L.map(g=>{const C=g.priority==="Urgent"?"var(--priority-urgent)":g.priority==="High"?"var(--priority-high)":"var(--primary)",b=g.category_color||C;return`
                  <div class="calendar-task-item" style="background: ${b.replace(")",", 0.15)").replace("hsl","hsla")}; border-left: 3px solid ${b}; color: #fff;" onclick="Components.showTaskDetails('${g.id}'); event.stopPropagation();">
                    ${g.title}
                  </div>
                `}).join("")}
            </div>
          </div>
        `}const v=42-(r+i);for(let m=1;m<=v;m++)d+=`
          <div class="calendar-cell inactive">
            <div class="calendar-date">${m}</div>
          </div>
        `;d+=`
              ...
              <div class="detail-side">
                ...
                <div>
                  ...
                  <div style="width: 100%; height: 8px; background: rgba(255,255,255,0.05); border-radius: 4px; overflow: hidden; margin-bottom: 1.2rem;">
                    <div style="width: ${i}%; height: 100%; background: linear-gradient(90deg, var(--accent-cyan), var(--primary)); border-radius: 4px;"></div>
                  </div>
    ...
    `,e.classList.remove("hidden")},async createTask(e){e.preventDefault();const s=document.getElementById("create-title").value.trim(),t=document.getElementById("create-desc").value.trim(),o=document.getElementById("create-status").value,a=document.getElementById("create-priority").value,r=document.getElementById("create-category").value,i=document.getElementById("create-assignee").value,n=document.getElementById("create-due").value,l=document.getElementById("create-estimate").value,d={title:s,description:t,status:o,priority:a,category_id:r||null,assignee_id:i||null,due_date:n||null,estimated_minutes:l?parseInt(l):0};try{await API.createTask(d),Utils.showToast("Task created successfully"),closeModal(),window.currentView==="dashboard"&&this.renderDashboard("view-dashboard"),window.currentView==="kanban"&&this.renderKanban("view-kanban"),window.currentView==="list"&&this.renderList("view-list"),window.currentView==="calendar"&&this.renderCalendar("view-calendar")}catch(c){Utils.showToast(`Failed to create task: ${c.message}`,"error")}},async renderLogs(e){const s=document.getElementById(e);if(s){s.innerHTML='<div class="loading">Loading audit logs...</div>';try{const t=await API.getActivityLogs();if(t.length===0){s.innerHTML=`
      ...
      `;t.forEach(a=>{const r=a.action,i=new Date(a.created_at),n=i.toLocaleTimeString([],{hour:"2-digit",minute:"2-digit"}),l=i.toLocaleDateString([],{month:"short",day:"numeric",year:"numeric"}),d=a.task_title?` on <strong style="color: var(--primary); cursor: pointer;" onclick="Components.showTaskDetails(${a.task_id})">${a.task_title}</strong>`:"";o+=`
          <div class="log-item">
      ...
      `,s.innerHTML=o}catch(t){s.innerHTML=`<div class="error-msg">Error loading activity logs: ${t.message}</div>`}}},async renderSettings(e){const s=document.getElementById(e);if(s){s.innerHTML='<div class="loading">Loading settings...</div>';try{this.categories=await API.getCategories();let t="";this.categories.forEach(o=>{const a=["Design","Engineering","Marketing","General"].includes(o.name),r=Utils.getCategoryStyle(o.color);t+=`
          <div style="display: flex; justify-content: space-between; align-items: center; padding: 0.8rem 1rem; background: rgba(255,255,255,0.02); border: 1px solid var(--border-glass); border-radius: var(--radius-sm); margin-bottom: 0.6rem;">
            <span class="category-tag" style="${r}">${o.icon} ${o.name}</span>
            ${a?`
      ...
      `}catch(t){s.innerHTML=`<div style="padding: 2rem; text-align: center; color: var(--priority-urgent);">Failed to load profile details: ${t.message}</div>`}}}};window.Components=S;window.currentView="dashboard";window.currentTimerTaskId=null;window.currentUser=null;let y=null,h=25*60,p=!1;document.addEventListener("DOMContentLoaded",async()=>{console.log("Zenith App booting...");const e=localStorage.getItem("theme"),s=document.getElementById("theme-icon-sun"),t=document.getElementById("theme-icon-moon");e==="light"?(document.documentElement.classList.add("light-theme"),s&&s.classList.remove("hidden"),t&&t.classList.add("hidden")):(document.documentElement.classList.remove("light-theme"),s&&s.classList.add("hidden"),t&&t.classList.remove("hidden")),window.app={togglePassword(a){const r=document.getElementById(a);r&&(r.type=r.type==="password"?"text":"password")},showAuthCard(a){a==="signup-card"?window.location.hash="#/signup":window.location.hash="#/login"},async handleFormLogin(a){a.preventDefault();const r=document.getElementById("login-email").value.trim(),i=document.getElementById("login-password").value,n=document.getElementById("login-spinner"),l=document.getElementById("btn-login-submit");n&&n.classList.remove("hidden"),l&&(l.disabled=!0);try{const d=await API.login({email:r,password:i});localStorage.setItem("token",d.token),Utils.showToast("Login successful! Loading workspace..."),window.currentUser=null,window.location.hash="#/dashboard"}catch(d){Utils.showToast(d.message,"error")}finally{n&&n.classList.add("hidden"),l&&(l.disabled=!1)}},async handleFormSignup(a){a.preventDefault();const r=document.getElementById("signup-name").value.trim(),i=document.getElementById("signup-email").value.trim(),n=document.getElementById("signup-password").value,l=document.getElementById("signup-confirm").value,d=document.getElementById("signup-spinner"),c=document.getElementById("btn-signup-submit");d&&d.classList.remove("hidden"),c&&(c.disabled=!0);try{const u=await API.register({fullName:r,email:i,password:n,confirmPassword:l});Utils.showToast(u.message),document.getElementById("signup-form").reset(),window.location.hash="#/login",setTimeout(()=>{const v=document.getElementById("login-email");v&&(v.value=i)},50)}catch(u){Utils.showToast(u.message,"error")}finally{d&&d.classList.add("hidden"),c&&(c.disabled=!1)}},async handleFormGuestLogin(){try{Utils.showToast("Generating guest sandbox session...");const a=await API.guestLogin();localStorage.setItem("token",a.token),Utils.showToast("Guest Login successful!"),window.currentUser=null,window.location.hash="#/dashboard"}catch(a){Utils.showToast(`Guest session failed: ${a.message}`,"error")}},async handleUserLogout(){try{localStorage.getItem("token")&&await API.logout()}catch(a){console.warn("Logout API warning:",a)}finally{localStorage.removeItem("token"),window.currentUser=null,p&&(clearInterval(y),p=!1),Utils.showToast("Logged out successfully."),window.location.hash="#/"}},showUpgradeScreen(){localStorage.removeItem("token"),window.currentUser=null,window.location.hash="#/signup"},toggleTheme(){const a=document.documentElement.classList.contains("light-theme"),r=document.getElementById("theme-icon-sun"),i=document.getElementById("theme-icon-moon");a?(document.documentElement.classList.remove("light-theme"),localStorage.setItem("theme","dark"),r&&r.classList.add("hidden"),i&&i.classList.remove("hidden")):(document.documentElement.classList.add("light-theme"),localStorage.setItem("theme","light"),r&&r.classList.remove("hidden"),i&&i.classList.add("hidden")),window.currentView==="dashboard"&&window.Components&&window.Components.renderDashboard("view-dashboard")}},document.querySelectorAll(".nav-item").forEach(a=>{a.addEventListener("click",()=>{const r=a.dataset.view;r&&(window.location.hash=`#/${r}`)})}),window.addEventListener("hashchange",k);const o=document.getElementById("btn-quick-new-task");o&&(o.onclick=()=>Components.showCreateTaskModal()),_(),await k()});async function k(){const e=window.location.hash||"#/",s=localStorage.getItem("token"),t=document.getElementById("landing-view"),o=document.getElementById("auth-view"),a=document.getElementById("app-view"),i=["#/","#/login","#/signup"].includes(e);if(!s){if(!i){console.log("Unauthenticated access blocked. Redirecting to landing page."),window.location.hash="#/",x();return}e==="#/"?x():e==="#/login"?T("login-card"):e==="#/signup"&&T("signup-card");return}if(!window.currentUser)try{const c=await API.getProfile();window.currentUser=c,D(c)}catch(c){console.error("Session validation failed on route change:",c),localStorage.removeItem("token"),window.location.hash="#/";return}if(i){window.location.hash="#/dashboard";return}t.classList.add("hidden"),o.classList.add("hidden"),a.classList.remove("hidden");const n=e.substring(2)||"dashboard";window.currentView=n,document.querySelectorAll(".nav-item").forEach(c=>{c.dataset.view===n?c.classList.add("active"):c.classList.remove("active")}),document.querySelectorAll(".view-panel").forEach(c=>{c.id===`view-${n}`?c.classList.remove("hidden"):c.classList.add("hidden")});const d={dashboard:{title:"Dashboard",subtitle:"Summary and analytics overview"},kanban:{title:"Kanban Board",subtitle:"Drag and drop workflow management"},list:{title:"Task List",subtitle:"Filterable list grid view"},calendar:{title:"Calendar",subtitle:"Deadlines and schedules tracker"},logs:{title:"Activity Logs",subtitle:"System event log auditing"},settings:{title:"Settings",subtitle:"Manage categories and import/export workspace data"}}[n];d&&(document.getElementById("view-title").textContent=d.title,document.getElementById("view-subtitle").textContent=d.subtitle),$(n)}function x(){document.getElementById("landing-view").classList.remove("hidden"),document.getElementById("auth-view").classList.add("hidden"),document.getElementById("app-view").classList.add("hidden")}function T(e){document.getElementById("landing-view").classList.add("hidden"),document.getElementById("app-view").classList.add("hidden"),document.getElementById("auth-view").classList.remove("hidden"),document.querySelectorAll(".auth-card").forEach(s=>{s.id===e?s.classList.remove("hidden"):s.classList.add("hidden")})}function D(e){const s=document.getElementById("header-user-avatar"),t=document.getElementById("header-user-name");s&&(s.textContent=e.avatar||"??"),t&&(t.textContent=e.fullName||"User");const o=document.getElementById("sidebar-user-avatar"),a=document.getElementById("sidebar-user-name"),r=document.getElementById("sidebar-user-email");o&&(o.textContent=e.avatar||"??"),a&&(a.textContent=e.fullName||"User"),r&&(r.textContent=e.email||"");const i=document.getElementById("header-guest-badge"),n=document.getElementById("btn-header-upgrade"),l=document.getElementById("guest-warning-banner");e.isGuest?(i&&i.classList.remove("hidden"),n&&n.classList.remove("hidden"),l&&l.classList.remove("hidden")):(i&&i.classList.add("hidden"),n&&n.classList.add("hidden"),l&&l.classList.add("hidden"))}function $(e){switch(e){case"dashboard":Components.renderDashboard("view-dashboard");break;case"kanban":Components.renderKanban("view-kanban");break;case"list":Components.renderList("view-list");break;case"calendar":Components.renderCalendar("view-calendar");break;case"logs":Components.renderLogs("view-logs");break;case"settings":Components.renderSettings("view-settings");break;default:console.warn(`Unknown view type requested: ${e}`)}}window.closeModal=()=>{const e=document.getElementById("modal-container");e&&e.classList.add("hidden")};function _(){const e=document.getElementById("global-timer-toggle"),s=document.getElementById("global-timer-reset"),t=document.getElementById("global-timer-display");!e||!s||!t||(e.onclick=()=>{p?(clearInterval(y),p=!1,e.textContent="Resume",t.classList.remove("timer-running")):(p=!0,e.textContent="Pause",t.classList.add("timer-running"),y=setInterval(()=>{h--;const o=Math.floor(h/60),a=h%60;t.textContent=`${o.toString().padStart(2,"0")}:${a.toString().padStart(2,"0")}`,h<=0&&(clearInterval(y),p=!1,e.textContent="Start",t.classList.remove("timer-running"),h=25*60,t.textContent="25:00",window.currentTimerTaskId?API.logTime(window.currentTimerTaskId,25,window.currentUser?window.currentUser.id:null).then(()=>{Utils.showToast("Pomodoro session completed! 25 minutes logged."),$(window.currentView)}).catch(r=>Utils.showToast(`Failed to log timer: ${r.message}`,"error")):Utils.showToast("Pomodoro session completed!"))},1e3))},s.onclick=()=>{clearInterval(y),p=!1,h=25*60,t.textContent="25:00",e.textContent="Start",t.classList.remove("timer-running")})}window.loadTimerTask=(e,s)=>{window.currentTimerTaskId=e;const t=document.getElementById("global-timer-task-name"),o=document.getElementById("global-timer-toggle"),a=document.getElementById("global-timer-reset");t&&(t.textContent=s),o&&(o.disabled=!1),a&&(a.disabled=!1)};
